---
name: update-docs
description: Update documentation to match recent code changes. Use after a feature lands, when docs have drifted from the implementation, or when the user asks to refresh README or reference docs following a change.
model: sonnet
---

> **Example skill.** Here to demonstrate the `SKILL.md` format taught in
