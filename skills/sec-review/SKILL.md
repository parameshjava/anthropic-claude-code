---
name: sec-review
description: Combined code quality and security review checklist for React and Next.js applications. Use when reviewing code for vulnerabilities, auditing against OWASP guidance, or when the user asks for a security review of frontend or full-stack changes.
model: opus
---
