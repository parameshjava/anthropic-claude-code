---
name: review
description: Automated code review checklist for React and Next.js applications. Use when reviewing a pull request, auditing code quality before merge, or when the user asks for a code review of React, Next.js, or frontend changes.
model: opus
---

> **Example skill.** This checklist targets a React/Next.js codebase, which this repo is not — it
> is here to demonstrate the `SKILL.md` format taught in
> [Chapter 15](../../slide-15-feature-decision-matrix.md).

## Companion skills

This skill assumes the following marketplace skills are installed:
...
Perform a comprehensive code review using your available skills including code quality review using the `code-quality` skill. Be thorough but concise. Utilize the `next-best-practices` and `vercel-react-best-practices` skills to ensure the code aligns with modern standards and `web-design-guidelines` skill for HTML and CSS best practices.
